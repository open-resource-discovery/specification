...
Now that ORD is [open-source](https://openresourcediscovery.org/) and a neutrally governed standard via [Linux Foundation](https://www.linuxfoundation.org/), a next step is to work with partners to establish it as an industry wide standard.
