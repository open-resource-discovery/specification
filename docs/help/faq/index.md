...
With [push transport](../../spec-v1/index.md#push-transport), a provider can publish when metadata changes; propagation then depends on submission validation and processing.
