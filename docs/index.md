...
<div className="lp-home">
  ...
  <div className="container">
    <div className="lp-overview-grid">
      ...
      <p>Technically, applications can expose a read-only entry point for pull-based discovery or push metadata to an ORD aggregator. The ORD standard is governed by the <a href="https://www.linuxfoundation.org/">Linux Foundation</a> / <a href="https://neonephos.org/">NeoNephos</a>.</p>
      </div>
