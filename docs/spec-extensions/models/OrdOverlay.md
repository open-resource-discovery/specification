...
**Type**: Object(<a href="#overlay-selector-by-ord-id_ordid">ordId</a>, <a href="#overlay-selector-by-ord-id_resourcetype">resourceType</a>)
...
|<div className="interface-property-name anchor" id="overlay-selector-by-ord-id_resourcetype">resourceType<br/><span className="optional">OPTIONAL</span><a className="hash-link" href="#overlay-selector-by-ord-id_resourcetype" title="#overlay-selector-by-ord-id_resourcetype"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">Optional hint when selecting by `ordId`.<br/>Specifies the ORD resource type to speed up resolution.<br/>If omitted, implementations SHOULD scan all resource types.<hr/>**Example Values**: <ul className="examples"><li>`"apiResource"`</li><li>`"eventResource"`</li><li>`"dataProduct"`</li></ul></div>|
