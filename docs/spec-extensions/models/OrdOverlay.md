...
**Type**: Object(<a href="#ord-overlay_$schema">$schema</a>, <a href="#ord-overlay_ordoverlay">ordOverlay</a>, <a href="#ord-overlay_ordid">ordId</a>, <a href="#ord-overlay_description">description</a>, <a href="#ord-overlay_describedsystemtype">describedSystemType</a>, <a href="#ord-overlay_describedsystemversion">describedSystemVersion</a>, <a href="#ord-overlay_describedsysteminstance">describedSystemInstance</a>, <a href="#ord-overlay_visibility">visibility</a>, <a href="#ord-overlay_target">target</a>, <a href="#ord-overlay_patches">patches</a>)
...
[Selector By JsonPath](#selector-by-jsonpath) \| [Selector By ORD ID](#selector-by-ord-id) \| [Selector By Operation](#selector-by-operation) \| [Selector By Entity Type](#selector-by-entity-type) \| [Selector By Property Type](#selector-by-property-type)<br/>

### Selector By JsonPath

**Type**: Object(<a href="#selector-by-jsonpath_jsonpath">jsonPath</a>)

| Property | Type | Description |
| -------- | ---- | ----------- |
|<div className="interface-property-name anchor" id="selector-by-jsonpath_jsonpath">jsonPath<br/><span className="mandatory">MANDATORY</span><a className="hash-link" href="#selector-by-jsonpath_jsonpath" title="#selector-by-jsonpath_jsonpath"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">JSONPath expression targeting any location in a JSON/YAML-based target document.<br/>MUST start with `$`.<br/>This is the generic fallback selector and is supported for all JSON/YAML-based metadata formats,<br/>including OpenAPI and MCP metadata files.<hr/>**Regex Pattern**: <code className="regex">^\\$</code><br/>**Minimum Length**: `1`<br/>**Example Values**: <ul className="examples"><li>`"$.paths./business-partners.get"`</li></ul></div>|


### Selector By ORD ID

**Type**: Object(<a href="#selector-by-ord-id_ordid">ordId</a>, <a href="#selector-by-ord-id_resourcetype">resourceType</a>)

| Property | Type | Description |
| -------- | ---- | ----------- |
|<div className="interface-property-name anchor" id="selector-by-ord-id_ordid">ordId<br/><span className="mandatory">MANDATORY</span><a className="hash-link" href="#selector-by-ord-id_ordid" title="#selector-by-ord-id_ordid"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">ORD ID targeting an ORD resource (API, Event, Data Product, ...).<br/>MUST be a valid [ORD ID](../../spec-v1/index.md#ord-id).<br/>Use this selector when patching ORD resource metadata itself.<hr/>**Regex Pattern**: <code className="regex">^([a-z0-9]+(?\:[.][a-z0-9]+)\*)\:([a-zA-Z0-9._\\-]+)\:([a-zA-Z0-9._\\-]+)\:(v0\|v[1-9][0-9]\*)$</code><br/>**Example Values**: <ul className="examples"><li>`"sap.s4:apiResource:OP_API_BUSINESS_PARTNER_SRV:v1"`</li></ul></div>|
|<div className="interface-property-name anchor" id="selector-by-ord-id_resourcetype">resourceType<br/><span className="optional">OPTIONAL</span><a className="hash-link" href="#selector-by-ord-id_resourcetype" title="#selector-by-ord-id_resourcetype"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">Optional hint when selecting by `ordId`.<br/>Specifies the ORD resource type to speed up resolution.<br/>If omitted, implementations SHOULD scan all resource types.<hr/>**Example Values**: <ul className="examples"><li>`"apiResource"`</li><li>`"eventResource"`</li><li>`"dataProduct"`</li></ul></div>|


### Selector By Operation

**Type**: Object(<a href="#selector-by-operation_operation">operation</a>)
...
**Type**: Object(<a href="#selector-by-entity-type_entitytype">entityType</a>)

| Property | Type | Description |
| -------- | ---- | ----------- |
|<div className="interface-property-name anchor" id="selector-by-entity-type_entitytype">entityType<br/><span className="mandatory">MANDATORY</span><a className="hash-link" href="#selector-by-entity-type_entitytype" title="#selector-by-entity-type_entitytype"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">Concept-level entity type identifier.<br/>Currently supported for OData metadata:<br/>- `edmx` (OData v2/v4 CSDL XML)<br/>- `csdl-json` (OData v4 CSDL JSON)<hr/>**Minimum Length**: `1`<br/>**Example Values**: <ul className="examples"><li>`"BusinessPartner"`</li><li>`"A_BusinessPartnerType"`</li></ul></div>|


### Selector By Property Type

**Type**: Object(<a href="#selector-by-property-type_propertytype">propertyType</a>, <a href="#selector-by-property-type_entitytype">entityType</a>)

| Property | Type | Description |
| -------- | ---- | ----------- |
|<div className="interface-property-name anchor" id="selector-by-property-type_propertytype">propertyType<br/><span className="mandatory">MANDATORY</span><a className="hash-link" href="#selector-by-property-type_propertytype" title="#selector-by-property-type_propertytype"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">Concept-level property/element identifier.<br/>Currently supported for OData metadata:<br/>- `edmx` (OData v2/v4 CSDL XML)<br/>- `csdl-json` (OData v4 CSDL JSON)<hr/>**Minimum Length**: `1`<br/>**Example Values**: <ul className="examples"><li>`"BusinessPartnerFullName"`</li><li>`"LegacySearchTerm1"`</li></ul></div>|
|<div className="interface-property-name anchor" id="selector-by-property-type_entitytype">entityType<br/><span className="mandatory">MANDATORY</span><a className="hash-link" href="#selector-by-property-type_entitytype" title="#selector-by-property-type_entitytype"></a></div>|<div className="interface-property-type">string</div>|<div className="interface-property-description">Entity type context of the selected property.<br/>This scopes the property lookup to avoid ambiguity.<br/>For OData metadata, this identifies the containing EntityType.<hr/>**Minimum Length**: `1`<br/>**Example Values**: <ul className="examples"><li>`"BusinessPartner"`</li><li>`"A_BusinessPartnerType"`</li></ul></div>|
