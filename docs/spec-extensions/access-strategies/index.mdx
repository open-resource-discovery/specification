...
- the ORD documents via [Access Strategy](../../spec-v1/interfaces/Configuration.md#ord-v1-document-access-strategy) in the ORD configuration.
- the referenced resource definition files via [Access Strategy](../../spec-v1/interfaces/Document.md#metadata-definition-access-strategy) in the ORD document.
