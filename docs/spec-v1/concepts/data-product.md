...
> They are described through high quality **metadata** that can be accessed through the Data Product Directory ([ORD Aggregator](../index.md#ord-aggregator)).
...
- The Data Product Directory ([ORD Aggregator](../index.md#ord-aggregator)) is used by Consumers to find and discover available Data Products.
