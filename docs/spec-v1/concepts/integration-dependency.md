...
> **Tip:** When the integration target resource uses an [authority namespace](../index.md#authority-namespace), a single dependency reference covers all system types providing that contract.
