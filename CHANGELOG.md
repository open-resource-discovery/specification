...
- Clarified perspective resolution for tenant-aware requests, including complete-view selection, per-resource absence, static fallback order, SemVer-based latest-version selection, and failure behavior.
