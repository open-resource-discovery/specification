...
- Added `vendor` and `partOfProducts` directly to all ORD resources as optional properties.
  When a contained resource omits `vendor`, ORD Aggregators SHOULD inherit the `vendor` assigned to its Package.
