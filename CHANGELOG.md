...
- Added autogenerated class diagrams for [ORD Documents](https://openresourcediscovery.org/spec-v1/diagrams/document) and [Configuration](https://openresourcediscovery.org/spec-v1/diagrams/configuration) Interface.
